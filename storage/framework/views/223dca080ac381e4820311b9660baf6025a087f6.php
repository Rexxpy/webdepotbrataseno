<head>
    ...
    * {
    ...
    <body>
        <h2>Edit Data</h2>
        <div class="container">
        <form action="<?php echo e(route('produk.update',
        ...
        <?php echo method_field("PUT"); ?>
            ...
            <div class="row">
                ...
                <div class="col-75">
                    ...
                    value="<?php echo e($produk->deskripsi); ?>">
                </div>
            </div>
            <div class="row">
...
</body><?php /**PATH C:\Users\andik\Documents\app\proyekeas\resources\views/editprod.blade.php ENDPATH**/ ?>